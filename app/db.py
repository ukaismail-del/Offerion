...
def _migrate_add_columns(app):
    ...
    migrations = [
        ...
        ("user_identity", "email_verified", "BOOLEAN DEFAULT 0"),
        ("user_identity", "email_verification_token_hash", "VARCHAR(255)"),
        ("user_identity", "email_verification_expires_at", "DATETIME"),
        ("user_identity", "email_verified_at", "DATETIME"),
        ("user_identity", "password_reset_token_hash", "VARCHAR(255)"),
        ("user_identity", "password_reset_expires_at", "DATETIME"),
        ("user_identity", "password_reset_requested_at", "DATETIME"),
