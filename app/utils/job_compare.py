...
JD_KEYWORDS = [
    "python", "sql", "flask", "django", "javascript", "typescript", "react",
    "angular", "vue", "node.js", "html", "css", "apis", "rest", "graphql",
    "git", "docker", "kubernetes", "aws", "azure", "gcp", "linux",
    "excel", "power bi", "tableau", "data analysis", "data science",
    "machine learning", "deep learning", "nlp", "statistics",
    "leadership", "communication", "project management", "agile", "scrum",
    "marketing", "sales", "finance", "customer service", "accounting",
...
def compare_resume_to_jd(resume_text, profile, jd_text):
    ...
    profile_skills = {s.lower() for s in profile.get("skills", []) if s != "Not detected"}
